using System;
using System.Data;
// sqlclient is the toolset needed
...
namespace web2.Models {
    public class Database {
		...
		// ----------------------------------------------------------- //
		// Name: InsertUser
		// Desc: Execute the Insert user stored procedure within the db
		// ----------------------------------------------------------- //
		...
		public User.ActionTypes InsertUser(User u) {
            try {
                ...
                // if dbconnection is false then throw error
				if (!GetDBConnection(ref cn)) throw new Exception("Database did not connect");
